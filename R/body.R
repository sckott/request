...
#' @param ...	Comma separated list of unquoted variable names. These are
#' combined into a list and passed to whatever http method is used downstream
...
#'  \item upload_file("path/"): The contents of a file. The mime type will be
#'  guessed from the extension, or can be supplied explicitly as the second
#'  argument to \code{upload_file()}
